...
public class GrantBuffEffect : Effect
{
    private readonly BuffType _buffType;
    public GrantBuffEffect(EffectBlueprint blueprint, BattleRoomDataProvider data, Card parentCard) : base(blueprint, data, parentCard)
    {
